...
// Space Complexity : O(1) as I am not taking any extra space
/*Approach
 * I am using binary search to reduce our search space by half for each iteration and check position of mid with respect to its value
